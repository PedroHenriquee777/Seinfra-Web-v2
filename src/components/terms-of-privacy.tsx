...
export function TermsDialog() {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl rounded-3xl border-transparent p-6">
        <DialogHeader>
          <DialogTitle className="flex justify-center font-bold text-seinfra-blue-light-400 text-xl">
            Termos de Privacidade e Serviço
          </DialogTitle>
        </DialogHeader>

        <div className="max-h-[60vh] overflow-y-auto pr-4 text-sm space-y-4 text-seinfra-blue-light-500">
        ...
        <div className="flex justify-center mt-6">
          <DialogClose asChild>
            <Button className="bg-seinfra-blue-light-300 text-background rounded-2xl px-8">
              Fechar
            </Button>
          </DialogClose>
        </div>
